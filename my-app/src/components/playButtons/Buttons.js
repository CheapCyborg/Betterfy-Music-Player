...
export default class Buttons extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <button class="btn btn-small" onClick={() => this.skipBackSong()}>
          <i class="fas fa-step-backward" />
        </button>
        <button class="btn btn-small" onClick={() => this.playCurrentSong()}>
          <i class="fas fa-play" />
        </button>
        <button class="btn btn-small" onClick={() => this.pauseCurrentSong()}>
          <i class="fas fa-pause-circle" />
        </button>
        <button class="btn btn-small" onClick={() => this.skipSong()}>
          <i class="fas fa-step-forward" />
        </button>
        <br />
        <button class={`btn btn-small${btnClass}`} onClick={() => this.click()}>
          <i class={`fas fa-random`} /> {this.state.isPressed}
        </button>
      </Fragment>
    );
  }
