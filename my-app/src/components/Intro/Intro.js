...
export default class IntroScreen extends Component {
  ...
  render() {
    return (
      <Fragment>
        <button className="btn btn-md btn-violet" onClick={this.buttonClick}>Log in with Spotify</button><br></br>
        <a target="_blank" href={this.links.announcement}>Spotify Web Playback SDK</a>
        &nbsp;
      </Fragment>
    );
  };
